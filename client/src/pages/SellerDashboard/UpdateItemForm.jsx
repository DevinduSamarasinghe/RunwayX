          ...
          <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
           {/* FORM ACTION */}
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="#">
                 <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Update Item</h2>
                ...
                <div class="flex items-center space-x-4">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 mt-4 rounded">
                        Update Item
                    </button>
