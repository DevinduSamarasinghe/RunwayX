...
const ClientPayTab = ({ payment }) => {
  ...
  return (
    <div className="">
      <div className= {payment.length > 4 ? "bg-white dark:bg-gray-700 shadow rounded-lg p-4 sm:p-6 xl:p-8 w-600" : "bg-white dark:bg-gray-700 shadow rounded-lg p-4 sm:p-6 xl:p-8 h-600 w-600"  }>
